...
InstallMethodWithCache( FunctorCategory,
  ...
  function ( B, C )
    ...
    if CheckConstructivenessOfCategory( C, "IsElementaryTopos" ) = [ ] and
       ## here we require in an essential way (1) that the range category C of the functor category is itself
       ## the range category of the homomorphism structure of the functor category:
          ...
          function ( Hom, F, G )
            ...
            AddObjectFunction( expFG,
              function( objB )
                ...
                ## but should live in the range category C of the functor category, hence the above assumption:
